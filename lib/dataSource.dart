...
class DataSource{
  ...
  static String quote = "\"Nothing in is to be feared, it is only to be understood. Now is the time to understand more, so that we may fearless.\"";
  ...
  static List questionAnswers = [
    ...
    },
    {
      "question":
          "Queries/Feedback",
      "answer":
              "Kindly mail us on: covidupdate29@gmail.com\nThank you! Stay Safe Stay Happy."
    }
  ];
  ...
  static List resources = [
    {
      "resource":
          "Covid-19 Data",
      "ans":
          "The public APIs are used to fetch data:\n1.https://corona.lmao.ninja/v2/all\n2.https://corona.lmao.ninja/v2/countries?sort=cases\n3.https://api.rootnet.in/covid19-in/stats/latest "
    },
    {
      "resource":
          "Hospital Data",
      "ans":
          "The public API are used to fetch data:\nhttps://api.rootnet.in/covid19-in/hospitals/beds"
    },
    {
      "resource":
          "Other Data",
      "ans":
          "1.https://selfregistration.cowin.gov.in/\n2.https://www.pmcares.gov.in/en/\n3.https://transformingindia.mygov.in/covid-19/?sector=myth-busters&type=en"
    }
  ];
}